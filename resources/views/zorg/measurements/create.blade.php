...
<div class="px-4 py-6 sm:px-0 max-w-4xl mx-auto">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="{{ route('zorg.measurements.store', $client) }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select id="measurementType"
                    ...
                    <option value="weight" @selected(old('type') === 'weight')>Gewicht</option>
                    <option value="blood_pressure" @selected(old('type') === 'blood_pressure')>Bloeddruk</option>
                    <option value="temperature" @selected(old('type') === 'temperature')>Temperatuur</option>
                    <option value="blood_sugar" @selected(old('type') === 'blood_sugar')>Bloedsuiker</option>
                </select>
            </div>
            ...
            <div id="fields-blood_pressure" class="hidden space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Bovendruk (systolic) *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Onderdruk (diastolic) *</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        showSelected(); // init (voor old('type'))
    });
</script>
@endsection